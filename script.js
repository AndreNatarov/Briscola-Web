...
var mazzo_di_carte = [];
    ...
    mazzo_di_carte[30] = new Carta(1, 0, 3, false);              //2 di coppe
    mazzo_di_carte[31] = new Carta(2, 0, 3, false);              //4 di coppe
    mazzo_di_carte[32] = new Carta(3, 0, 3, false);              //5 di coppe
    mazzo_di_carte[33] = new Carta(4, 0, 3, false);              //6 di coppe
    mazzo_di_carte[34] = new Carta(5, 0, 3, false);              //7 di coppe
    mazzo_di_carte[35] = new Carta(6, 2, 3, false);              //fante di coppe
    mazzo_di_carte[36] = new Carta(7, 3, 3, false);              //cavaliere di coppe
    mazzo_di_carte[37] = new Carta(8, 4, 3, false);              //re di coppe
    mazzo_di_carte[38] = new Carta(9, 10, 3, false);              //3 di coppe
    mazzo_di_carte[39] = new Carta(10, 11, 3, false);              //asso di coppe
